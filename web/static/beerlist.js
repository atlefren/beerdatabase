...
(function (ns) {
    ...
    var TableHeaderCell = React.createClass({displayName: 'TableHeaderCell',
        ...
        render: function () {
            ...
            if (this.props.isSorted) {
                if (this.props.sortDirection === 'desc') {
                    sort = (React.createElement("i", {className: "fa fa-caret-down"}));
                } else {
                    sort = (React.createElement("i", {className: "fa fa-caret-up"}));
                }
            }
            return (
    ...
    ns.SortableTable = React.createClass({displayName: 'SortableTable',
        ...
        render: function () {
            ...
            return (
                React.createElement("table", {className: "u-full-width table-sortable"}, 
    ...
    var columns = [
        {
            ...
            formatter: function (brewery) {
                return (React.createElement("a", {href: '/breweries/' + brewery.id}, brewery.name));
            },
            sortParams: 'name',
            isSorted: true,
            sortDirection: 'asc'
    ...
    var columns = [
        {
            ...
            formatter: function (beer) {
                return (
                    React.createElement("a", {href: '/pol_beers/' + beer.id}, 
                        beer.name
                    )
                );
            },
...
(function (ns) {
    ...
    var ScoreDisplay = React.createClass({displayName: 'ScoreDisplay',
        ...
        render: function () {
            return (
                React.createElement("div", {className: "one column score-box"}, 
    ...
    var ExternalLink = React.createClass({displayName: 'ExternalLink',
        render: function () {
            return (
                React.createElement("li", {className: "navbar-item"}, 
                    React.createElement("a", {href: this.props.link.url, className: "navbar-link"}, 
    ...
    var Pie = React.createClass({displayName: 'Pie',
        ...
        getSvg: function () {
            ...
            if (value >= 100) {
                return (
                    React.createElement(SVGComponent, {height: size, width: size}, 
                        React.createElement("circle", {r: radius, cx: radius, cy: radius})
                    ) 
                );
            }
        ...
        getHelpMsg: function () {
            ...
            return (
                React.createElement("div", {className: "alert alert-warning"}, 
                    React.createElement("strong", null, "Hjelp:"), ' ', 
                    "Dette ølet heter ", ' ', " ", React.createElement("em", null, this.props.beer.name), ' ', " og er brygget" + ' ' +
                    "av ", ' ', " ", React.createElement("em", null, this.props.beer.producer), " ", ' ', " ifølge Vinmonopolet.", ' ', 
                    "Hvis dette ikke stemmer kan det godt skyldes en feilmatching,", ' ', 
                    "fint om du kan si fra om feilen ", ' ', " ", React.createElement("a", {href: err_url}, "her"), "."
                )
            );
        },
...
(function (ns) {
    ...
    var StyleList = React.createClass({displayName: 'StyleList',
    ...
    var StyleListWrapper = React.createClass({displayName: 'StyleListWrapper',
...
(function (ns) {
            ...
            return (
                React.createElement("div", {className: "row"}, 
                    React.createElement("div", {className: "six columns"}, 
                        React.createElement("h3", null, "Øl fra polet"), 
                        React.createElement("table", {className: "u-full-width"}, 
                            React.createElement("tbody", null, 
                                React.createElement("tr", null, 
                                    React.createElement("th", null, "Bryggeri"), 
                                    React.createElement("td", null, this.props.beer.producer)
                                ), 
                                React.createElement("tr", null, 
                                    React.createElement("th", null, "Navn"), 
                                    React.createElement("td", null, this.props.beer.name)
                                ), 
                                React.createElement("tr", null, 
                        ...
                        React.createElement("table", {className: "u-full-width"}, 
                            React.createElement("tbody", null, 
                                React.createElement("tr", null, 
                                    React.createElement("th", null, "Abv"), 
                                    React.createElement("th", null, "Farge"), 
    ...
    var RbBeerOverview = React.createClass({displayName: 'RbBeerOverview',
        ...
        render: function () {
            ...
            return (
                React.createElement("div", {className: "row"}, 
                    React.createElement("div", {className: "six columns"}, 
                        React.createElement("h3", null, "Øl fra Ratebeer"), 
                        React.createElement("table", {className: "u-full-width"}, 
                            React.createElement("tbody", null, 
                                React.createElement("tr", null, 
                                    React.createElement("th", null, "Bryggeri"), 
    ...
    var BeerFixer = React.createClass({displayName: 'BeerFixer',
        ...
        render: function () {
            ...
            if (this.state.mappingId) {
                return (
                    React.createElement("div", null, 
                        React.createElement("p", null, "Ditt forslag til rettelse er registrert og vil snart bli behandlet")
                    )
                );
            }
            return (
                React.createElement("div", null, 
                    React.createElement(PolBeerOverview, {beer: this.props.pol_beer}), 
                    React.createElement(RbBeerOverview, {
...
(function (ns) {
    ...
    var Slider = React.createClass({displayName: 'Slider',
        ...
        render: function () {
            return (React.createElement("div", {className: "slider noUi-extended"}));
        }
    });

    var NameSearcher = React.createClass({displayName: 'NameSearcher',
        ...
        render: function () {
            return (
                React.createElement("fieldset", null, 
                    React.createElement("label", null, "Navn"), 
                    React.createElement("input", {
                        type: "text", 
    ...
    var StyleChooser = React.createClass({displayName: 'StyleChooser',
        ...
        render: function () {
            ...
            return (
                React.createElement("fieldset", null, 
                    React.createElement("label", null, "Stil"), 
                    ...
                    React.createElement("label", null, 
                        React.createElement("input", {onChange: this.toggleAll, checked: this.state.allSelected, type: "checkbox"}), 
                        React.createElement("span", {className: "label-body"}, "Velg alle")
                    )
                )
            );
        }
    ...
    var SliderFieldSet = React.createClass({displayName: 'SliderFieldSet',
            ...
            return (
                React.createElement("fieldset", null, 
                    React.createElement("label", null, this.props.label), 
                        React.createElement("div", null, 
                            React.createElement("div", null, min, this.props.displayPostfix, " til ", max, this.props.displayPostfix), 
                            React.createElement(Slider, React.__spread({}, 
                                this.props, 
    ...
    var CheckboxComponent = React.createClass({displayName: 'CheckboxComponent',
        ...
        render: function () {
            return (
                React.createElement("label", null, 
                    ...
                    React.createElement("span", {className: "label-body"}, this.props.name)
                )
            );
        }
    });

    var AvailableAtChooser = React.createClass({displayName: 'AvailableAtChooser',
        ...
        render: function () {
            ...
            return (
                React.createElement("fieldset", null, 
                    React.createElement("legend", null, "Tilgjengelig på"), 
                    checkboxes
                )
            );
        }
    ...
    resultColumns.unshift({
        ...
        formatter: function (beer) {
            if (beer.pol_id) {
                return (
                    React.createElement("a", {href: '/pol_beers/' + beer.pol_id}, 
                        beer.name
                    )
                );
            }
    ...
    var SearchPage = React.createClass({displayName: 'SearchPage',
        ...
        render: function () {
            ...
            return (
                React.createElement("div", {className: "row"}, 
                    React.createElement("div", {id: "search_field", className: "three columns"}, 
                        React.createElement(SearchField, {
                            onSearch: this.doSearch, 
                            searchParams: this.props.searchParams, 
                            initValues: this.props.initValues})
                    ), 
                    React.createElement("div", {id: "search_resuts", className: "nine columns"}, 
                        results
                    )
                )
            );
